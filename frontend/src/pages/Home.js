        ...
        <section className="hero-section">
          <div className="container">
            ...
            <p className="hero-subtitle">
              Read honest reviews from real students and discover the best dorms
              at your university.
            </p>
              ...
              <div className="search-box">
                <div className="search-input-wrapper">
                  ...
                  <input
                    ...
                    placeholder="Search universities, cities, or dorms..."
        ...
        <section className="featured-dorms-section">
          <div className="container">
            ...
            <p className="section-subtitle">
              Discover highly-rated dorms from top universities
            </p>
